...
const Familycode = () => {
    ...
    return (
        <>
        {isVisible === true && <Modal isVisible={isVisible} setIsVisible={setIsVisible} type={modalType}/>}
        <Container onSubmit={handleSubmit(onSubmit)}>
            ...
            <InputWrap>
                    <CodeInput type='radio' name='type' id='create' value='create'
                        ref={register({ reqire: true })}
                    />
                    <Icon>
                        <img src={`${process.env.PUBLIC_URL}/images/check_18px.png`} alt="체크" />
                    </Icon>
            ...
            <InputWrap>
                    <CodeInput type='radio' name='type' id='join' value='join' 
                        ref={register({ reqire: true })}
                    />
                    <Icon>
                        <img src={`${process.env.PUBLIC_URL}/images/check_18px.png`} alt="체크" />
